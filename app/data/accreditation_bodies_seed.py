...
# 플랫폼 운영 14규격 (display_code, name_ko) — standards_catalog.OPERATING_STANDARDS 와 동기
# QMS/EMS 는 2015·2026 판 분리. BCMS(ISO 22301) 는 운영 14에 미포함.
from app.data.standards_catalog import OPERATING_STANDARDS

ENTERPRISE_ISO_STANDARDS: List[Tuple[str, str]] = [
    (s.display_code, s.name_ko) for s in OPERATING_STANDARDS
]
